  ...
  const plans = [
    {
      ...
      price: "₹0",
      credits: 100,
      description: "Perfect for beginners starting interview preparatio.",
      features: [
        "100 AI Interview Credits",
        "Basic Performance Report",
        "Voice Interview Access",
        "Limited History Traking",
      ],
      default: true,
    },
    {
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-gray-50 to-emerald-50 py-16 px-6'>
      ...
      <div className='max-w-6xl mx-auto mb-14 flex items-start gap-4'>
        ...
        <button className='mt-2 p-3 rounded-full bg-white shadow hover:shadow-md transition'>
          <FaArrowLeft onClick={()=>navigate("/")} className='text-gray-600'/>
        </button>
