...
function Step3Report({ report }) {
  ...
  const downloadPDF = () => {
    ...
    if (finalScore >= 8) {
      advice = 
      "Excellent performance. Maintain confidence and structure. Continue refining clarity and supporting answer with strong real-world examples.";
    }else if (finalScore >= 5) {
      advice = 
      "Good foundation shown. Improve clarity and structure. Practice delivering concise, confident answer with stronger supporting examples.";
    }else {
      advice =
    ...
    doc.setFont("helvetica", "bold");
    doc.text("Profesional Advice", margin + 10, currentY + 10);
  ...
  return (
    <div className='min-h-screen bg-linear-to-br from-gray-50 px-4 sm:px-6 lg:px-10 py-8'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8'>
        ...
        <div className='space-y-6'>
          <motion.div
            ...
            <div className='realative w-20 h-20 sm:w-25 sm:h-25 mx-auto'>
              <CircularProgressbar
                value={percentage}
                text={`${score}/10`}
                styles={buildStyles({
