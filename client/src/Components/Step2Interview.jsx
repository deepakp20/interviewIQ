...
function Step2Interview({interviewData, onFinish}) {
  ...
  const speakText = (text)=>{
    return new Promise((resolve)=>{
      ...
      // Add natural pauses after commas periods
        ...
        <div className='w-full lg:w-[35%] bg-white flex flex-col items-center p-6 border-r border-gray-200'>
          ...
          <div className='w-full max-w-md bg-white border border-gray-200 rounded-2xl shadow-md p-6 space-y-5'>
            ...
            <div className='grid grid-cols-2 gap-6 text-center'>
              ...
              <div>
                <span className='text-2xl font-bold text-emerald-600'>{question.length}</span>
            ...
            <div className='flex-1 flex flex-col p-4 sm:p-6 md:p-8 relative'>
              ...
              {!isIntroPhase && (<div className='relative mb-6 bg-gray-50 p-4 sm:p-6 rounded-2xl border border-gray-200 shadow-sm'>
                ...
                <div className='text-base sm:text-lg font-semibold text-gray-800 leading-relaxed pr-16'>{currentQuestion?.question}
                </div>
              </div>)}
              ...
              value={answer}
              className='flex-1 bg-gray-100 sm:p-6 rounded-2xl resize-none outline-none border border-gray-200 focus:ring-2 focus:ring-emerald-500 transition text-gray-800'/>
